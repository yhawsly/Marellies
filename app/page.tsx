...
export default function Home() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Portfolio Preview / Gallery Strip (Optional Visual Break) */}
      <section className="py-20 bg-black text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <img src="https://images.unsplash.com/photo-1759124649699-010eeb1f69f8?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="h-64 w-full object-cover rounded-md hover:scale-105 transition-transform duration-500" alt="Gallery 1" />
            <img src="https://plus.unsplash.com/premium_photo-1674027290746-a54ed7de32b5?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="h-64 w-full object-cover rounded-md hover:scale-105 transition-transform duration-500" alt="Gallery 2" />
            <img src="https://images.unsplash.com/photo-1768776182889-607915c299a6?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="h-64 w-full object-cover rounded-md hover:scale-105 transition-transform duration-500" alt="Gallery 3" />
            <img src="https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?q=80&w=1000&auto=format&fit=crop" className="h-64 w-full object-cover rounded-md hover:scale-105 transition-transform duration-500" alt="Gallery 4" />
          </div>
